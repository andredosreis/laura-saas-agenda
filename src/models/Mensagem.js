...
const MensagemSchema = new mongoose.Schema({
  ...
  // no inbox), 'sistema' (lembrete/notificação automática) ou 'cliente' (inbound).
  // Aditivo e opcional — docs antigos não têm o campo; o inbox trata ausência
  // de 'ia'/'humano' em outbound como IA.
  geradoPor: { type: String, enum: ['ia', 'humano', 'cliente', 'sistema'] },
