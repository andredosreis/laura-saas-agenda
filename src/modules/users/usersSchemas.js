...
const permissoesSchema = z
  .object({
    ...
    gerenciarHistorico: z.boolean().optional(),
    ...
    editarFinanceiro: z.boolean().optional(),
    registrarPagamentos: z.boolean().optional(),
    verLeads: z.boolean().optional(),
    criarLeads: z.boolean().optional(),
    editarLeads: z.boolean().optional(),
    deletarLeads: z.boolean().optional(),
    responderLeads: z.boolean().optional(),
